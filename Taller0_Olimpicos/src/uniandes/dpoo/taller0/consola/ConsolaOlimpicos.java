...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Pais al que un atleta representa");
	...
	private void ejecutarRepresentanteAtleta()
	{
		String nombreAtleta = input("\n" + "Ingrese el nombre del atleta" + "\n");
		String nombrePais = calculadora.representanteAtleta(nombreAtleta).darNombre();
		System.out.println("El pais que representa el atleta es " + nombrePais);
	}
