...
public class CalculadoraEstadisticas
{
	...
	/**
	 * Retorna el pais de un atleta dado
	 * @parameter nombre de un atleta
	 * @return el pais al que representa un atleta
	 */
	public Pais representanteAtleta(String nombreAtleta) 
	{
		Atleta elAtleta = null;
		elAtleta = buscarAtleta(nombreAtleta);
		return elAtleta.darPais();
	}
